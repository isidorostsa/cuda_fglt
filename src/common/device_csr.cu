...
d_csr::d_csr(const h_csr &_h_csr) : rows(_h_csr.get_rows()), cols(_h_csr.get_cols()), nnz(_h_csr.get_nnz()),
                                            offsets(_h_csr.get_offsets()), positions(_h_csr.get_positions()), values(_h_csr.get_values()) {}
